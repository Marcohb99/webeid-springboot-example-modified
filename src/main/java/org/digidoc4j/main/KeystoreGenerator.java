  ...
  public static void main(String[] args) {
    try {
      KeystoreGenerator.aGenerator()
          .withCertificateDirectory("D:\\Documentos\\uma\\tfg\\web_eid_modified\\web-eid-spring-boot-example-latest\\web-eid-spring-boot-example\\src\\main\\resources\\certs\\spain_certs")
          .withKeyStoreFilepath("D:\\Documentos\\uma\\tfg\\web_eid_modified\\web-eid-spring-boot-example-latest\\web-eid-spring-boot-example\\src\\main\\resources\\trusted_certificates_modified.jks")
          .generateKeystore();
